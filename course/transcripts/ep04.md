...
*[MAP: THE CITADEL MAP]*
**NOVA:** RA, PL, PM, CA — is this whole layer about decisions instead of walls?
...
*[VERBATIM] “Develop security and privacy plans for the system that: Are consistent with the organization’s enterprise architecture;” — NIST SP 800-53r5  ·  PL-2 System Security and Privacy Plans*
**ARCHIVIST:** Develop security and privacy plans for the system that: Are consistent with the organization’s enterprise architecture;
...
**VEGA:** Remember — PM controls aren't selected per system from a baseline.
**VEGA:** They run across the whole organization, all the time.

*[VERBATIM] “Develops a comprehensive strategy to manage: Security risk to organizational operations and assets, individuals, other organizations, and the Nation associated with the operation and use of organizational systems;” — NIST SP 800-53r5  ·  PM-9 Risk Management Strategy*
**ARCHIVIST:** Develops a comprehensive strategy to manage: Security risk to organizational operations and assets, individuals, other organizations, and the Nation associated with the operation and use of organizational systems;
...
**NOVA:** So this whole layer is the thinking behind the RMF — risk, plans, governance, checking?

*[QUIZ] A new system is ready to go live. Which control is where a senior official formally accepts the risk?*
  A. CA-6 Authorization (answer)
  B. RA-3 Risk Assessment
  C. PL-2 System Plan
**NOVA:** Scenario: go-live day. Which control signs off the risk?
...
**NULL:** Built, you say? I'll poison it at the source.
