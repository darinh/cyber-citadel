...
**VEGA:** Then we secure where systems are made and supplied.
...
*[MAP: THE CITADEL MAP]*
**NOVA:** SA, CM, MA, SR — is this all about how you build and buy the thing?
...
*[VERBATIM] “Apply the following systems security and privacy engineering principles in the specification, design, development, implementation, and modification of the system and system components: [organization-defined systems security and privacy engineering principles].” — NIST SP 800-53r5  ·  SA-8 Security and Privacy Engineering Principles*
**ARCHIVIST:** Apply the following systems security and privacy engineering principles in the specification, design, development, implementation, and modification of the system and system components: [organization-defined systems security and privacy engineering principles].
...
**VEGA:** Trust is built from the first sketch — you can't bolt it on at the end.
...
**NOVA:** We already met 'baseline' back in episode zero.
...
**VEGA:** The Blueprint-Master's oath is this. A known system is a defended system.
...
**NULL:** Your remote support line… I had such plans for it.
...
*[QUIZ] A counterfeit network card arrives pre-tampered. Which control should catch it?*
  ...
  C. MA-2 Maintenance
**NOVA:** Scenario: a tampered part in the box. Whose job is that?
