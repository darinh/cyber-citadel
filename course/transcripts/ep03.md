...
**VEGA:** And that is why the strongest controls guard the people, and their data.
...
*[MAP: THE CITADEL MAP]*
**NOVA:** AT, PS, PT — these sound very human. Who are we meeting?
...
**VEGA:** You train the human. AT-2 builds the reflex to hang up on the kind of call we opened with.
...
*[VERBATIM] “Provide security and privacy literacy training to system users (including managers, senior executives, and contractors): As part of initial training for new users and [organization-defined frequency] thereafter;” — NIST SP 800-53r5  ·  AT-2 Literacy Training and Awareness*
**ARCHIVIST:** Provide security and privacy literacy training to system users (including managers, senior executives, and contractors): As part of initial training for new users and [organization-defined frequency] thereafter;
...
*[VERBATIM] “Upon termination of individual employment: Disable system access within [time period];” — NIST SP 800-53r5  ·  PS-4 Personnel Termination*
**ARCHIVIST:** Upon termination of individual employment: Disable system access within [time period];
...
**NOVA:** Privacy gets its own family now? That must be pretty new?
...
**NOVA:** So — get permission when it's needed, and be honest about how the data's used?
...
**NOVA:** Notebook: the strongest controls aren't always technical — sometimes they're just people keeping promises.
