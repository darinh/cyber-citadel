...
*[BREACH OF THE WEEK:  — Tagged 'low value' — so it was guarded like it.]*
  Put high-impact data on a system labeled low, and the crown jewels get junk-tier protection. Get the category wrong, and every choice after it is wrong too.
**NULL:** Tell me a system doesn't matter — and I'll make it the one that ends you.
**VEGA:** So first, Nova, we learn to judge what a system is truly worth.
...
**NOVA:** Confidentiality, Integrity, Availability — the C-I-A triad! We covered that back in Orientation.
...
**NULL:** Mislabel it low, and you'll guard it like nothing. That is where I will live.
...
*[QUIZ] A system is Confidentiality=Moderate, Integrity=Low, Availability=High. Its category is?*
  ...
  B. Moderate
  C. High (answer)
**NOVA:** Scenario time. What's the overall category?
