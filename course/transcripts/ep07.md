...
*[TITLE: 07 — ALL TWENTY GUARDIANS — All twenty guardians · The Risk Management Framework]*
**VEGA:** One attacker, many weapons. One city, twenty guardians. This is defense in depth.

*[MAP: THE CITY STANDS AS ONE]*
**NARRATOR:** He strikes everywhere at once. Watch the city answer.
...
**VEGA:** Each weapon meets a guardian — and the city holds.
**NULL:** Repelled — this time. I just mapped every lock you have. Next time, I bring the right keys.
...
*[THE ROLL CALL: Five oaths, one shield]*
...
**NOVA:** Five oaths — and the whole city holds.

*[TITLE: GUARDIAN ROLL CALL — Five questions across the whole city]*
**NOVA:** Five questions, across all twenty guardians? Okay — let's see what I remember.
