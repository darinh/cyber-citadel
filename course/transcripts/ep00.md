...
**NULL:** I don't want your walls. I want what they guard — the Crown Data. And trust? Trust shatters so easily.
...
**NOVA:** Confidentiality, Integrity, Availability — so that's what every guardian is really protecting?
...
**NOVA:** But why do we even need all this?
...
**NOVA:** Eight-hundred fifty-three — that's the catalog, right? What's actually in it?
**VEGA:** Hundreds of controls, organized into families — a menu you put to work.
...
*[HOW TO READ A CONTROL: Anatomy of a control]*
  ...
  • Enhancements, add-ons that strengthen it — required when your baseline selects them, e.g., AC-6(1)
...
**NOVA:** And what's the 'discussion' part for?
**VEGA:** It gives context and rationale — helpful, but not itself a requirement.
**VEGA:** Related controls point to neighbors. Enhancements add strength — for example, AC-6 enhancement 1. References point outside the catalog.
...
**NOVA:** Wait — Low, Moderate, High... where do those baselines actually live?
**VEGA:** Good eye. In Revision 5 they moved out, into a companion book: 800-53B.
...
**NOVA:** So the catalog's 800-53, and 800-53B's baselines help pick where we start?
