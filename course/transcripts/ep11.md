...
**NOVA:** Examine, interview, test — three ways to actually prove it works?
...
**NOVA:** So — assess, write up what you found, plan for the gaps, package it, then the AO signs?
...
**NULL:** The ink dries... and I'm already past the next wall.
...
*[QUIZ] What are the three assessment methods in SP 800-53A?*
  ...
  C. Plan, Do, Check
**NOVA:** Final stretch. Name the three assessment methods.
...
**NOVA:** In Episode zero, I didn't even know what eight-hundred fifty-three was. Tonight, I finally understand what that signature means.
**VEGA:** Then keep the watch, Castellan. That's what the signature begins.
**NULL:** I will return. There is always a next time.
**NOVA:** Then we never stop watching.
