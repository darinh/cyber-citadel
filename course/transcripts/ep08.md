...
**NOVA:** So it's the process that tells you what to do — and in what order?
...
**NOVA:** So it's a cycle? Monitoring never really stops?
...
*[QUIZ] How many steps are in the RMF (SP 800-37 Rev 2)?*
  ...
  B. Six
  C. Seven (answer)
**NOVA:** Quick check. How many steps in the framework?
